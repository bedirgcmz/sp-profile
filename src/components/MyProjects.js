    ...
    >
      <div className="my-projects-container">
        <div className="projects-info-text">
          <h2 className="mb-4">
            <span>My Projects</span> <i class="fa-solid fa-laptop-code"></i>
          </h2>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <a
                    ...
                    target="_blank"
                  >
                    Github Link <i className="fa-brands fa-github ms-2"></i>
                  </a>
                  <a
                    ...
                    target="_blank"
                  >
                    Go Project <i className="fa-solid fa-eye ms-2"></i>
                  </a>
                </div>
              </div>
            </div>
